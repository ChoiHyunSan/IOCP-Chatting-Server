...
CMonitor::CMonitor(HANDLE hProcess)
{
	...
	PdhAddCounter(_cpuQuery, L"\\Process(LoginChatServer)\\Private Bytes", NULL, &_processUserMemory);
	PdhAddCounter(_cpuQuery, L"\\Process(LoginChatServer)\\Pool Nonpaged Bytes", NULL, &_processNonpagedMemory);
	PdhAddCounter(_cpuQuery, L"\\Memory\\Available MBytes", NULL, &_availableMemory);
	PdhAddCounter(_cpuQuery, L"\\Memory\\Pool Nonpaged Bytes", NULL, &_nonpagedMemory);
